...
export function Topbar({ mode, onMode, canSwitch, impersonating }: Props) {
  return (
    <div
    ...
    >
      ...
      {impersonating ? (
        <span className="inline-flex items-center gap-[6px] text-[12px] font-semibold px-[11px] py-[5px] rounded-[20px]" style={{ background: "#fff7e6", color: "#8a6d1f", border: "1px solid #f6e2b4" }}>
